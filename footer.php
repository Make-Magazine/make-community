				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 logo" >
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/make-footer.png" alt="MAKE">	
					...
					<div class="row">
						...
						<div class="col-md-3 about-us">
							...
							<div class="about-column-01">
								<ul>
									<li><a href="<?php echo get_makezine_home_url( '/help/index.html' ); ?>">Help</a></li>
									<li><a href="http://makermedia.com/contact-us/" target="_blank">Contact</a></li>
									<li><a href="<?php echo get_makezine_home_url( '/go/subscribe2make' ); ?>">Subscribe</a></li>
							...
							<div class="about-column-02">
								<ul>
									...
									<li><a href="<?php echo get_makezine_home_url( '/faq/index.html' ); ?>">FAQ</a></li>
									<li><a href="<?php echo get_makezine_home_url( '/community/index.html' ); ?>">Forums</a></li>
									<li><a href="<?php echo get_makezine_home_url( '/contribute/' ); ?>">Write for MAKE</a></li>
								</ul>
						...
						<div class="col-md-3 subscribe">
							<a href="https://readerservices.makezine.com/mk/subscribe.aspx?PC=MK&PK=M**NEWB" target="_blank">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/footer-make-cover.jpg" alt="MAKE Magazine Cover" width="115" height="163" id="mag-cover">
							</a>
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/arrow-footer.png" width="80" height="48" id="mag-arrow">
